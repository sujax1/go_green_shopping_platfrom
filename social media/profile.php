        ...
        display: flex;
            ...
            <div class="main-coluam">
                <?php                   
                        $username = $user_array['username'];
                        $ret_str = "";
                        $data_query = mysqli_query($conn, "SELECT * FROM posts ORDER BY id DESC");
                            ...
                            while($row = mysqli_fetch_array($data_query)) {
                                ...
                                if($username == $added_by){
                                    ...
                                    $user_details_query = mysqli_query($conn, "SELECT first_name, last_name, profile_pic FROM users WHERE username='$added_by'");
                                    ...
                                    <?php
                                    // count comments
                                    $comment_check = mysqli_query($conn,"select * from comments where post_id='$id'");
