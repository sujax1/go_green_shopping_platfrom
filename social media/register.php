...
<head>
    ...
    <title>Wellcome to Green Book</title>
    ...
    <!-- favigon -->
    <link rel="shortcut icon" href="social media\images\logos-removebg-preview.png" type="image/x-icon">
...
<div class="top-content">
    <h1 style="font-size:35px; color: green;">Welcome to Green Book, share your Tree Plantation moments with others!</h1>
    <p style="color: blue;">Sign up and start sharing your photos and updates with your friends.</p>
    ...
    <footer>			
    	<div class="footer"> 
    		...
    		<p> ©2023 All Rights Reserved <BR> Website designed and developed by <strong><U>Team green</u></strong></p>
    	</div>
    </footer>
