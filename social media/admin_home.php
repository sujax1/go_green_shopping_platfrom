...
<?php 
    ...
    if(isset($_SESSION['username'])){
        $user_details_query = mysqli_query($conn, "SELECT * FROM admin WHERE adminname='$userLoggedIn'")or die(mysqli_error($conn));
     ...
     $user_detail_query = mysqli_query($conn,"select * from admin where adminname='$userLoggedIn'");
     $user_array = mysqli_fetch_array($user_detail_query);

     //total users
     $count_user_query = mysqli_query($conn,"select * from users");
     $count_user = mysqli_num_rows($count_user_query);

     //total posts
     $count_post_query = mysqli_query($conn,"select * from posts");
