...
<?php include 'header.php'; 
    ...
    if(isset($_POST['submit_cover_pic'])){
        ...
        if($uploadOk){
            $update_covet_pic = mysqli_query($conn, "update users set cover_pic='$imageName' where username='$userLoggedIn'") or die(mysqli_error($conn));
    ...
    if(isset($_POST['submit_profile_pic'])){
        ...
        if($uploadOk){
            $update_covet_pic = mysqli_query($conn, "update users set profile_pic='$imageName' where username='$userLoggedIn'") or die(mysqli_error($con));
            // header("Location: account_settings.php");
        }
        else{
            echo $errorMessage;
    ...
    if(isset($_POST['submit_Fname'])){
        ...
        $Fname = mysqli_real_escape_string($conn, $Fname); //egnore the ' in post boddy
    ...
    if(isset($_POST['submit_Lname'])){
        ...
        $Lname = mysqli_real_escape_string($conn, $Lname); //egnore the ' in post boddy
        $query = mysqli_query($conn, "update users set last_name='$Lname' where username='$userLoggedIn'") or die("cannot update".mysqli_error($con));
        if($query)
    ...
    if(isset($_POST['submit_date'])){
        ...
        $DOB = mysqli_real_escape_string($conn, $DOB); //egnore the ' in post boddy
        $query = mysqli_query($conn, "update users set dob='$DOB' where username='$userLoggedIn'") or die("cannot update".mysqli_error($con));
        if($query)
    ...
    if(isset($_POST['submit_htown'])){
        ...
        $h_town = mysqli_real_escape_string($conn, $h_town); //egnore the ' in post boddy
        $query = mysqli_query($conn, "update users set hometown='$h_town' where username='$userLoggedIn'") or die("cannot update".mysqli_error($con));
        if($query)
