...
<body>
    ...
    if (isset($_POST['postComment' . $post_id])){
        ...
        $insert_post = mysqli_query($conn, "INSERT INTO comments (post_body, posted_by, posted_to, date_added, removed, post_id) VALUES ('$post_body', '$userLoggedIn', '$posted_to', '$date_time_now', 'no', '$post_id')") or die("cannot inset".mysqli_error($conn));
