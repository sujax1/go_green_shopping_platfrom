...
<div class="header_bar">
    <a href="index.php" style="text-decoration: none; color: Green;"><img src="images\logo.png" alt="O" style="height: 50px; width: 100px; margin: 18px 3px -10px 30px;">
    <span style="font-family:cursive;/*! text-decoration:overline; */font-size: 45px;">GREEN BOOK</span></a>
