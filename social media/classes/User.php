...
<?php 
    ...
    class User{
        ...
        public function __construct($conn, $user){
            $this->conn = $conn; //this -> con = private $con (connection)
        ...
        public function didSendRequest($user_to){
            ...
            $check_request_query = mysqli_query($this->conn, "select * from friend_requests where user_to='$user_to' and user_from='$user_from'")or die(mysqli_error($this->conn));
            if(mysqli_num_rows($check_request_query) > 0){
                return true;
            }
            else {
