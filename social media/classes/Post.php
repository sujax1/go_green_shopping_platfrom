...
<?php 
    ...
    class Post{
        ...
        public function submitPost($body, $imageName){
            ...
            $body = mysqli_real_escape_string($this->conn, $body); //egnore the ' in post boddy
            ...
            if($check_empty != ""){
                ...
                $query = mysqli_query($this->conn, "INSERT INTO posts (body, added_by, date_added, user_closed, deleted, likes, image) VALUES('$body', '$added_by', '$date_added', 'no', 'no', '0', '$imageName')");
        ...
        public function indexPosts () {
            ...
            $ret_str = "";
            $data_query = mysqli_query($this->conn, "SELECT * FROM posts ORDER BY id DESC");
                ...
                while($row = mysqli_fetch_array($data_query)) {
				    ...
				    // if($user_logged_obj->isFriend($added_by)){
                        ...
                        <?php
                        // count comments
                        $comment_check = mysqli_query($this->conn,"select * from comments where post_id='$id'");
